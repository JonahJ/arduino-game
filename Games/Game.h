 ...
 */
    ...
    #define GAME_BRIGHTNESS (uint8_t)25
 ...
 */
#ifndef GAME_DRAW_MODE_SIMPLE
    #define GAME_DRAW_MODE_SIMPLE true
#endif /* GAME_DRAW_MODE_SIMPLE */

/**
 * Draw board row wise
 */
#ifndef GAME_DRAW_MODE_ROW_WISE
    #define GAME_DRAW_MODE_ROW_WISE GAME_DRAW_MODE_SIMPLE + 1
 ...
 */
    ...
    // #define GAME_DRAW_MODE GAME_DRAW_MODE_SIMPLE
...
void Game::draw() {
    ...
    #if (GAME_DRAW_MODE == GAME_DRAW_MODE_SIMPLE)
        ...
        led_matrix->show();
        return;
    #endif /* GAME_DRAW_MODE == GAME_DRAW_MODE_SIMPLE */

    // #if (GAME_DRAW_EFFECT_WIPE && GAME_DRAW_CLEAR_ON_REDRAW)
    //     #if (GAME_DRAW_MODE_SPIRAL)
    //         for (i_col = 0; i_col < width; i_col++) {
    //             for (i_row = 0; i_row < height; i_row++) {
    ...
    //     led_matrix->show();
    // #endif /* GAME_DRAW_EFFECT_WIPE && GAME_DRAW_CLEAR_ON_REDRAW */
